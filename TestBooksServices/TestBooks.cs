...
namespace TestBooksServices
{
    ...
    public class TestBooks
    {
        ...
        public async Task TestGetBook()
        {
            ...
            BooksApp.Services.IApiService servic = new ApiServices(http,Settings.URL);
        ...
        public async Task TestUpdateBook()
        {
            ...
            IApiService servic = new ApiServices(http, Settings.URL);
            bool result = await servic.Update(1, book);
            Assert.AreEqual(result, true);
        }
        [TestMethod]
